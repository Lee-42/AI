...
console.log("  pnpm example:deepseek:image-tool DeepSeek + image tool strawberry count");
console.log("");
...
console.log("  pnpm example:deepseek:image-tool");
console.log("");
...
console.log(`Default strawberry image URL: ${config.examples.strawberryImageUrl ?? "Wikimedia fallback"}`);

...
| [AI 文本流协议](docs/protocol/AI_STREAM_PROTOCOL.md) | Implemented | SSE/RTC 职责、流事件、取消传播与背压 |
...
| [知识源治理](docs/architecture/KNOWLEDGE_SOURCE_GOVERNANCE.md) | Implemented | Source Manifest、租户复合键、版本状态机与两阶段删除 |
| [知识入库 Pipeline](docs/architecture/KNOWLEDGE_INGESTION_PIPELINE.md) | Implemented | 受限解析、确定性清洗/切片、Metadata 与稳定 ID |
| [知识向量索引](docs/architecture/KNOWLEDGE_VECTOR_INDEX.md) | Implemented | Embedding/Collection 契约、增量 Upsert、旧向量安全清理与费用开关 |
| [混合知识召回](docs/architecture/HYBRID_KNOWLEDGE_RETRIEVAL.md) | Implemented | 查询规划、强制 Tenant/Source Scope、Dense + Lexical 与 RRF 候选融合 |

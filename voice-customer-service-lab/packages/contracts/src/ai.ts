...
export const AiCitationSchema = Type.Object(
  {
...
export const AiStreamEventSchema = Type.Union(
  [
    Type.Object(
      {
        ...AiStreamEnvelope,
        event_type: Type.Literal("stream.started"),
    ...
    Type.Object(
      {
        ...AiStreamEnvelope,
        event_type: Type.Literal("answer.delta"),
        payload: Type.Object(
          {
            index: Type.Integer({ minimum: 0 }),
            text_delta: Type.String({ minLength: 1, maxLength: 1_000 }),
          },
          { additionalProperties: false },
        ),
      },
    ...
    Type.Object(
      {
        ...AiStreamEnvelope,
        event_type: Type.Literal("answer.completed"),
        payload: Type.Object(
          {
            answer_mode: AiAnswerModeSchema,
            evidence_status: AiEvidenceStatusSchema,
    ...
    Type.Object(
      {
        ...AiStreamEnvelope,
        event_type: Type.Literal("stream.cancelled"),
        payload: Type.Object(
          { reason: Type.Literal("caller_cancelled") },
          { additionalProperties: false },
        ),
      },
      { additionalProperties: false },
    ...
    Type.Object(
      {
        ...AiStreamEnvelope,
        event_type: Type.Literal("stream.failed"),
        payload: Type.Object(
          {
...
/** OpenAPI documents the wire as text/event-stream; each data field is one AiStreamEvent JSON value. */
export const AiDebugStreamResponseSchema = Type.String({
  $id: "AiDebugStreamResponse",
  contentMediaType: "text/event-stream",
});
export type AiDebugStreamResponse = Static<typeof AiDebugStreamResponseSchema>;
